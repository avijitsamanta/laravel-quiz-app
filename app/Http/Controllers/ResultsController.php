...
class ResultsController extends Controller
{
    ...
    public function index()
    {
        ...
        $allResults = Result::where('user_id',Auth::user()->id)->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($questions) {
            ...
            // Mail::to($result->topic->user)->send(
            //     new QuizAttempt($result->topic)
            // );
            // $data = array('topic'=>$result->topic);
            //  Mail::send('emails.quizmail', $data, function($message) {
                
            //     $message->to('avijit.tict@gmail.com', 'Tutorials Point')->subject
