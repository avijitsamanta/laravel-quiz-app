        ...
        <div class="container">
            ...
            <div class="form-group">
                <form action="{{route('topics.store')}}" method="post">
                    @csrf
                    <div class="form-group">
                        <input type="text" name="title" class="form-control" placeholder="Add quiz">
                    </div>
                    <div class="form-group">
                        <input type="number" name="quiz_time" class="form-control" placeholder="Add quiz time">
                    </div>
                    <input type="submit" name="submit" id="submit" class="btn btn-info" value="Create Quiz"/>
                </form>
            </div>
                        ...
                        <table class="table table-bordered" id="dynamic_field">
                            ...
                            <tr>
                                <td>
                                    ...
                                    />
                                <td>
                                    <input type="text" name="options[]" placeholder="Add answer"
        ...
        $(document).ready(function () {
            ...
            $('#addAnswer').click(function () {
                ...
                $('#dynamic_field').append('' +
                    ...
                    '</td>' +
                    '<td>' +
                    '<input type="text" name="options[]" required placeholder="Add answer" class="form-control question_list" />' +
                    '</td>' +
                    '<td>' +
